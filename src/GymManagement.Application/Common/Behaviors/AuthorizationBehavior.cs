        ...
        where TResponse : IErrorOr
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return (dynamic)Error.Unauthorized(description: "User'Permissions is forbidden from taking this action");
        }
        ...
        {
            return (dynamic)Error.Unauthorized(description: "User'Roles is forbidden from taking this action");
        }
